        ...
        public void handleMessage(Message msg) {
            ...
            if ( msg.what == ACTION_CHANGE_ALHPA) {
                ...
                if(mTouchAgain)
                    return;
                isRunning = true;
                int padding = 0 - mIvFloatLogo.getWidth() /2;
...
//        hide();
    ...
    private View createView(final Context context) {
        ...
        mIvFloatLogo = rootFloatView.findViewById(R.id.pj_float_view_icon_imageView);
        mLlFloatMenu = rootFloatView.findViewById(R.id.ll_menu);
